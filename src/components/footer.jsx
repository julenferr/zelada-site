  ...
  return (
    <footer data-scroll data-scroll-speed="-0.2" id="footer" className="pt-5 gap-5 relative flex justify-between flex-col">
    	...
    	<div className="pl-5 pr-5 col-span-12 grid grid-cols-4 md:grid-cols-12">
    		...
    		<ul className="col-start-1 md:col-start-8 col-span-12 md:col-span-4">
    			<li className="mb-7 mt-2">
                   ...
                   <div className="ml-9">
                       ...
                       <a className="lg:inline block" href="+5491132463210">+54 9 11 3246-3210</a>
    			   </div>
                </li>
    			<li>
    			   <span className="mb-2">DIRECCIÓN</span>
    			   <a className="ml-9 block" href="#">Av. Gral. Benjamín Victorica 3101,<br /> C1427DGD Ciudad Autónoma de Buenos Aires</a>
    			</li>
    		</ul>
    	</div>
